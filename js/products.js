    ...
    const valorantCategories = [
      { id: "rank-boosting", label: "Rank Boosting", icon: "rank", badge: null, badgeType: null, featured: true, thumb: "assets/thumbnails/valorant/valorant-rank-boosting.webp" },
      { id: "placement-matches", label: "Placement Matches", icon: "placement", badge: null, badgeType: null, featured: false, thumb: "assets/thumbnails/valorant/valorant-placement-matches.webp" },
      { id: "radiant-boost", label: "Radiant Boost", icon: "radiant", badge: "HOT", badgeType: "hot", featured: false, thumb: "assets/thumbnails/valorant/valorant-radiant-boost.webp" },
      { id: "ranked-wins", label: "Ranked Wins", icon: "wins", badge: null, badgeType: null, featured: false, thumb: "assets/thumbnails/valorant/valorant-ranked-wins.webp" },
      { id: "unrated-games", label: "Unrated Games", icon: "unrated", badge: null, badgeType: null, featured: false, thumb: "assets/thumbnails/valorant/valorant-unrated-games.webp" },
      { id: "account-leveling", label: "Account Leveling", icon: "leveling", badge: null, badgeType: null, featured: false, thumb: "assets/thumbnails/valorant/valorant-account-leveling.webp" },
      { id: "battle-pass", label: "Battle Pass", icon: "battle-pass", badge: "NEW", badgeType: "new", featured: false, thumb: "assets/thumbnails/valorant/valorant-battle-pass.webp" },
      { id: "coaching", label: "Coaching", icon: "coaching", badge: null, badgeType: null, featured: false, thumb: "assets/thumbnails/valorant/valorant-coaching.webp" }
    ];
